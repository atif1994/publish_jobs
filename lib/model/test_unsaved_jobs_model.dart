class TestUsavedjobModel {
  ...
  TestUsavedjobModel.fromJson(Map<String, dynamic> json) {
...
class Pivot1 {
  ...
  Pivot1({this.jobId, this.countryId});
...
class Pivot2 {
  ...
  Pivot2({this.jobId, this.jobtypeId});
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['job_id'] = this.jobId;
    data['jobtype_id'] = this.jobtypeId;
    return data;
  }
}
