...
namespace INVACC.Reports.EmpAttendance {
    ...
    public class DW_Closing4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "INVACC.Reports.EmpAttendance.DW_Closing4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDW_Closing4 : Component, ICachedReport {
        
        public CachedDW_Closing4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DW_Closing4 rpt = new DW_Closing4();
            rpt.Site = this.Site;
            return rpt;
        }
