...
import '../../profile_model/job_get_prefer_position_model.dart';
...
class AddPreferJobPositon extends StatefulWidget {
  const AddPreferJobPositon({Key? key}) : super(key: key);

  @override
  State<AddPreferJobPositon> createState() => _AddPreferJobPositonState();
}

class _AddPreferJobPositonState extends State<AddPreferJobPositon> {
  List<GetJobPositonModel> preferJobPositionListData = [];
  ...
  Future<List<dynamic>> getpreferPositionList() async {
    ...
    var res = await http.get(
      Uri.parse("https://api.publish.jobs/api/get-jobPosition"),
    ...
    for (Map<String, dynamic> i in data) {
      setState(() {
        preferJobPositionListData.add(GetJobPositonModel.fromJson(i));
      });
    }
    setState(() {
      matches = resBody;
  ...
  String idData = '';
  String title = '';
  GetJobPositonModel skillModel = GetJobPositonModel();
  List<GetJobPositonModel?> _selectPreferjobPosition = [];
  List<GetJobPositonModel?> _selectedAnimalsdata = [];
  List<dynamic> selectedjobPositionId = [];
  ...
  Widget build(BuildContext context) {
    ...
    final _items = preferJobPositionListData
        .map((Skill) =>
            MultiSelectItem<GetJobPositonModel?>(Skill, Skill.title.toString()))
        .toList();
    ...
    return Scaffold(
      ...
      appBar:AddAppBar(
        appBarText: "Prefer job Position",
      ),
      body: Padding(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      MultiSelectBottomSheetField<GetJobPositonModel?>(
                        confirmText: Text(
                          "Ok",
                          style: TextStyle(
                        ...
                        onConfirm: (values) {
                          setState(() {
                            ...
                            _selectPreferjobPosition =
                                values as List<GetJobPositonModel?>;
                            print(_selectPreferjobPosition.toString() +
                        ...
                        chipDisplay: MultiSelectChipDisplay(
                          onTap: (item) {
                            // _selectedAnimalsdata=item?.id.toString() as List<GetJobPositonModel?>;
                            setState(() {
                              _selectPreferjobPosition.remove(item);
                            });
                            _multiSelectKey.currentState!.validate();
                          },
                        ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Consumer<PostPreferJobPositionController>(
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          child: GestureDetector(
                              onTap: () {
                                for (int i = 0;
                                    i < _selectPreferjobPosition.length;
                                    i++) {
                                  setState(() {
                                    selectedjobPositionId.add(
                                        _selectPreferjobPosition[i]!.id.toString() ?? 0);
                                  });
                                }
                                var data = {
                                  'jobPosition': selectedjobPositionId
                                };
                                val.addJobSeekerPreferresPosition(
                                    data, context);
                              ...
                              child: Center(
                                child: val.loadingAddPosition == false
                                    ? Text(
                                        "Save Changes",
                                        style: TextStyle(
                                            color: isDarkMode == false
