...
class PostGenderController with ChangeNotifier{
  bool loadingMartialStatus = false;
  jobSeekerAddGenderStatus(String id, BuildContext context) async {
    ...
    try {
      ...
      notifyListeners();
      String url =
          "https://api.publish.jobs/api/jobseekerAddGender?id=$id";
      ...
      if (response.statusCode == 200) {
        ...
        notifyListeners();
        GlobalVarData.genderStatus = 'not null';
        Get.back();
      } else {
