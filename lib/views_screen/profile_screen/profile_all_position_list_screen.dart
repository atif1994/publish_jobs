...
class AllPositonListShow extends StatefulWidget {
  const AllPositonListShow({Key? key}) : super(key: key);

  @override
  State<AllPositonListShow> createState() => _AllPositonListShowState();
}

class _AllPositonListShowState extends State<AllPositonListShow> {
  @override
  bool deleteData = false;
  bool deleteDataUpdation = false;
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("Add Your desire Job Position to the employers", style: TextStyle(
              fontWeight: FontWeight.w500,
              fontSize: 14,
              color: isDarkMode == true
                  ? Colors.white
          ...
          FutureBuilder<List<JobSeekerPreferredPositionModel>>(
            future: GetPreferredPositionController().getJobSeekerPreferredPosition(),
                            ...
                            Consumer<PostDeleteAlertProfileBase>(
                              builder: (context, val, child) {
                                return ElevatedButton(
                                  ...
                                  child:val.loadingPreferredPositionDelete==false? Text(
                                    "Delete",
                                    style: TextStyle(
                                        color: isDarkMode == false
